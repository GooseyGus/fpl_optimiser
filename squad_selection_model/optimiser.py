...
df_players_gw1 = pd.read_csv('data/fpl_players_gw_1.csv')
df_players_gw2 = pd.read_csv('data/fpl_players_gw_2.csv')
...
prob = add_objective_function(prob, df_players_gw2, vars, penalty_points=4)
...
#prob = add_bench_selection_constraints(prob, vars, df_players_gw2)
